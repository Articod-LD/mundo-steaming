...
class ProviderController extends Controller
{
    ...
    function find(Request $request, $provider_id)
    {
    ...
    {
        $notAllowedPermissions = [Permission::SUPER_ADMIN, Permission::CUSTOMER];
    ...
    public function update(updapteUserProfileRequest $request, $provider_id)
    {
        $data = $request->all();
        $user = $this->repository
            ->where('id', $provider_id)
    ...
    function destroy(Request $request, $provider_id)
    {
        $hoy = Carbon::now();
