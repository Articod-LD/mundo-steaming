...
export default function HeroCarousel() {
  ...
  if (loading) {
    return <div className="w-full h-[740px] flex justify-center items-center bg-gray-950">
  ...
  return (
    <div className="relative">
      {banner.length > 0 ? (
        ...
        <div className="w-full h-[740px] flex justify-center items-center bg-gray-950">
