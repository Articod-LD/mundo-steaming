    ...
    >
      <Menu.Button className="flex max-w-[150px] items-center gap-2 focus:outline-none lg:py-0.5 xl:py-2.5">
        ...
        <div className="hidden w-[calc(100%-48px)] flex-col items-start space-y-0.5 truncate text-sm ltr:text-left rtl:text-right xl:flex">
          <span className="w-full truncate font-semibold capitalize text-white">
            {data?.name}
          </span>
      ...
      >
        <Menu.Items
          as="ul"
          className="authorized-menu absolute mt-3 w-56 rounded-lg border border-gray-200 bg-white shadow-box end-0 origin-top-end focus:outline-none lg:mt-4 xl:mt-2 z-10"
        >
          <Menu.Item>
          ...
          <Menu.Item>
            <li className="border-b border-dashed border-gray-200 p-2 focus:outline-none text-black">
              <Link
                href={routes.editar_perfil}
                className="group flex items-center gap-2 rounded-md py-2.5 px-3 text-sm capitalize transition duration-200 hover:text-accent text-heading text-black"
              >
          ...
          <Menu.Item>
            <li className={cn("cursor-pointer px-2 ")}>
              <Link
                href={routes.logout}
                className="group flex items-center gap-2 rounded-md py-2.5 px-3 text-sm capitalize transition duration-200 hover:text-accent text-heading text-black"
              >
