      ...
      <div className="mt-24 px-5 lg:px-20 w-full flex h-[560px] flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 sm:pl-12 lg:py-28">
          ...
          <p className="text-base mt-3 ">
            COMBIPREMIUM es una tienda online de plataformas de streaming. Con
            una trayectoria de más de 5 años, nos enorgullecemos de ofrecer a
            nuestros más de 7 mil clientes una experiencia de entretenimiento
            ...
            los gustos y preferencias. Desde películas emocionantes hasta
            programas de televisión adictivos y música que te hace mover.
            COMBIPREMIUM tiene todo lo que necesitas para llevar tu experiencia
            de entretenimiento al siguiente nivel. ¡Somos tu puerta de entrada
            al mundo del entretenimiento ilimitado!
          </p>
          {me ? (
            <button
